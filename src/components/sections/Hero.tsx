...
//               <img src="/dp.jpg" alt="Athulya M" className="relative w-full h-full object-cover rounded-full p-2" />
//             </motion.div>
//         </div>
...
//           >
//             I'm Athulya M, an AI & DS student and Full-stack Developer. I specialize in 4.0 Technologies, harnessing data science, machine learning, and robust engineering to drive innovation.
//           </motion.p>
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between w-full">
        ...
        <div className="relative w-48 h-48 md:w-[450px] md:h-[450px] rounded-full mb-10 md:mb-0 z-20 flex-shrink-0 origin-center">
            ...
            >
              {/* Circular spinning animated border */}
              <div 
                className="absolute inset-[-4px] rounded-full animate-[spin_3s_linear_infinite]"
                style={{
                  background: 'conic-gradient(from 0deg, transparent 0%, var(--grad-start) 30%, var(--grad-middle) 70%, var(--grad-end) 100%)',
                  WebkitMask: 'radial-gradient(closest-side, transparent calc(100% - 4px), black calc(100% - 3px))',
                  mask: 'radial-gradient(closest-side, transparent calc(100% - 4px), black calc(100% - 3px))'
                }}
              />
              <img src="/dp.jpg" alt="Athulya M" className="relative w-full h-full object-cover rounded-full p-1" />
            </motion.div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left md:w-1/2 z-30">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-foreground opacity-60 max-w-2xl mb-12 font-sans"
          >
            I'm Athulya M, a Computer Science student at Jyothi Engineering College. I am a passionate web developer with a strong interest in AI technologies, blending modern development with intelligent systems to build innovative solutions.
          </motion.p>
